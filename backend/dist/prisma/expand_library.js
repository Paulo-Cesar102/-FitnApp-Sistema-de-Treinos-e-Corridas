...
async function main() {
    ...
    const novosExercicios = [
        { id: "ex-burpee", name: "Burpees", cat: "HIIT", muscle: fullBody.id, level: client_1.Difficulty.ADVANCED, img: "https://images.unsplash.com/photo-1599058917233-97f3941560dc?w=600" },
        { id: "ex-polichinelo", name: "Polichinelos", cat: "Cardio", muscle: fullBody.id, level: client_1.Difficulty.BEGINNER, img: "https://images.unsplash.com/photo-1434608519344-49d77a699e1d?w=600" },
        { id: "ex-prancha", name: "Prancha Abdominal", cat: "Funcional", muscle: core.id, level: client_1.Difficulty.BEGINNER, img: "https://images.unsplash.com/photo-1566241142559-40e1dab266c6?w=600" },
        { id: "ex-kettlebell", name: "Kettlebell Swing", cat: "Funcional", muscle: core.id, level: client_1.Difficulty.INTERMEDIATE, img: "https://images.unsplash.com/photo-1517963879433-6ad2b056d712?w=600" },
        { id: "ex-mountain-climber", name: "Mountain Climbers", cat: "HIIT", muscle: core.id, level: client_1.Difficulty.INTERMEDIATE, img: "https://images.unsplash.com/photo-1434608519344-49d77a699e1d?w=600" },
        { id: "ex-stretch-cat", name: "Alongamento Gato-Vaca", cat: "Mobilidade", muscle: core.id, level: client_1.Difficulty.BEGINNER, img: "https://images.unsplash.com/photo-1552196564-972d4638c331?w=600" },
        { id: "ex-pushup", name: "Flexão de Braços", cat: "Calistenia", muscle: core.id, level: client_1.Difficulty.BEGINNER, img: "https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?w=600" },
    ];
    ...
    const treinosCatalogo = [
        {
            ...
            level: client_1.Difficulty.BEGINNER,
            exercises: [
        ...
        },
        {
            ...
            level: client_1.Difficulty.ADVANCED,
            exercises: [
        ...
        },
        {
            ...
            level: client_1.Difficulty.INTERMEDIATE,
            exercises: [
